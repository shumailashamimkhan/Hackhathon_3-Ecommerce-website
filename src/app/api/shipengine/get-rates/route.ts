import { shipengine } from "./../../../../../src/helper/shipEngine"; // Import ShipEngine client
...
// Define the "ship from" address (e.g., your warehouse or business address)
    ...
    const shipmentDetails = await shipengine.getRatesWithShipmentDetails({
      ...
      rateOptions: {
        carrierIds: [
          process.env.SHIPENGINE_FIRST_COURIER || "se-1710367",
          process.env.SHIPENGINE_SECOND_COURIER || "se-1710368",
          process.env.SHIPENGINE_THIRD_COURIER || "se-1710369",
          process.env.SHIPENGINE_FOURTH_COURIER || "se-1710443",
